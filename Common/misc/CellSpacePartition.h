...
// 
// Desc: 2D 공간을 다수의 엔티티를 포함할 수 있는 셀의 그리드로 분할하는 클래스입니다. 엔티티를 생성하고 초기화하면 위치와 근접 반경을 가진 CalculateNeighbors 메서드를 호출하여 빠른 근접 쿼리를 수행할 수 있습니다.
//
...
//
// 엔티티가 이동할 수 있고 따라서 셀 간에 이동할 수 있는 경우 Update 메서드는 각 Update-cycle(업데이트 사이클)이라고 불러야 합니다 개체와 개체가 차지하는 셀 공간을 동기화합니다
//-----------------------------------------------------------------------------
