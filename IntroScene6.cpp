...
IntroScene6::IntroScene6()
{
	Introfile = CImagefile::New(MAKEINTRESOURCE(IDB_INTRO6),L"IDB_INTRO6");
...
bool IntroScene6::IsFinished()
{
	return FinishedCheck;
}

void IntroScene6::onFrameMove()
{
	if (DelayFirst())
	{
		delta++;
...
void IntroScene6::onDraw(HDC hdc)
{
	mBG.Draw(hdc);
	HFONT oldFont;
