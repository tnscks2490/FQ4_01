...
IntroScene7::IntroScene7()
{
	Introfile = CImagefile::New(MAKEINTRESOURCE(IDB_INTRO7),L"IDB_INTRO7");
...
bool IntroScene7::IsFinished()
{
	return FinishedCheck;
}

void IntroScene7::onFrameMove()
{
	if (DelayFirst())
	{
		delta++;
...
void IntroScene7::onDraw(HDC hdc)
{
	mBG.Draw(hdc);
	HFONT oldFont;
