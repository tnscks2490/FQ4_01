...
{
	Introfile = CImagefile::New(MAKEINTRESOURCE(IDB_INTRO9),L"IDB_INTRO9");
...
bool IntroScene9::IsFinished()
{
	return FinishedCheck;
}

void IntroScene9::onFrameMove()
{
	if (DelayFirst())
	{
		delta++;
...
void IntroScene9::onDraw(HDC hdc)
{
	mBG.Draw(hdc);
	HFONT oldFont;
