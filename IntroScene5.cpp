...
IntroScene5::IntroScene5()
{
	Introfile = CImagefile::New(MAKEINTRESOURCE(IDB_INTRO5),L"IDB_INTRO5");
...
bool IntroScene5::IsFinished()
{
	return FinishedCheck;
}

void IntroScene5::onFrameMove()
{
	if (DelayFirst())
	{
		delta++;
...
void IntroScene5::onDraw(HDC hdc)
{
	mBG.Draw(hdc);
	HFONT oldFont;
